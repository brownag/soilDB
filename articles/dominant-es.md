...
```
    ...
    ## Dimension:     XY
    ## Bounding box:  xmin: -120.8546 ymin: 37.9834 xmax: -120.8252 ymax: 38.01049
    ## Geodetic CRS:  WGS 84
    ##     mukey    area_ac                           geom
    ## 1 2924958  84.229770 POLYGON ((-120.8488 38.0086...
    ## 2 2924958 115.522394 POLYGON ((-120.8358 37.9969...
    ## 3 1403409  11.128110 POLYGON ((-120.8482 37.9869...
    ## 4 2924959 125.390668 POLYGON ((-120.8276 37.9851...
    ## 5 2924959   6.101858 POLYGON ((-120.8344 37.9956...
    ## 6 1605512 183.795875 POLYGON ((-120.8482 37.9869...
...
```
    ...
    ## 4                  Peters-Pentz (s836)      <NA> POLYGON ((-120.801 37.92773...
    ## 5 Whiterock-Rock outcrop-Auburn (s818)      <NA> POLYGON ((-120.5276 37.9624...
...
```
    ...
    ## 1 2924958      CA632 17969 Amador sandy loam, 2 to 15 percent slopes 27449956
    ## 2 2924958      CA632 17969 Amador sandy loam, 2 to 15 percent slopes 27449957
    ## 3 2924958      CA632 17969 Amador sandy loam, 2 to 15 percent slopes 27449958
    ## 4 2924958      CA632 17969 Amador sandy loam, 2 to 15 percent slopes 27449959
    ## 5 2924958      CA632 17969 Amador sandy loam, 2 to 15 percent slopes 27449960
    ## 6 2924958      CA632 17969 Amador sandy loam, 2 to 15 percent slopes 27449961
    ##   coecoclasskey comppct_r majcompflag     compname  localphase
    ## 1      12784213        76         Yes       Amador        <NA>
    ## 2      12784214         9         No     Gillender        <NA>
    ## 3      12784215         5         No   Miltonhills        <NA>
    ## 4      12784216         5         No        Pardee        <NA>
    ## 5      12784217         2         No       Redding        <NA>
    ## 6            NA         1         No  Rock outcrop acidic tuff
    ##             compkind   ecoclassid                       ecoclassname
    ## 1             Series  R018XI107CA Shallow, Undulating Volcanic Hills
    ## 2         Taxadjunct  R018XI163CA          Thermic Low Rolling Hills
    ## 3             Series  F018XI207CA   Deep Volcanic Plateaus and Hills
    ## 4             Series  R018XI107CA Shallow, Undulating Volcanic Hills
    ## 5             Series  R018XI163CA          Thermic Low Rolling Hills
    ## 6 Miscellaneous area Not assigned                       Not assigned
    ...
    ## 3 NRCS Forestland Site Ecological Site Description Database
